...
<html>
  <head>
    <title>Weatherbit API Test</title>
  </head>
  <body>
    <h1>Weatherbit API Test</h1>
    <form>
        ...
        API Key: <input name="key" type="text" value="<?= htmlentities($key) ?>" size="32" /><br /><br />
        City: <input name="city" type="text" value="<?= htmlentities($city) ?>" size="20" /><br /><br />
        Country: <?= countryPulldown($country) ?><br /><br />
        Forecast Days (1-16): <input name="days" type="text" value="<?= $days ?>" size="2" maxlength="2"/>
        <br /><br />
...
/**
 * @param string $selectedCountryCode - (optional, default '') 2 letter country code of selected country
 * @return string - html select pulldown
 */
function countryPulldown($selectedCountryCode = '')
{
    $countries = [
        '' => '',
        'US' => 'United States',
    ...
    $pulldown = '<select name="country">';
    foreach ($countries as $code => $country) {
        $selected = '';
        if ($code == strtoupper($selectedCountryCode)) {
            $selected = ' selected="selected"';
        }
        $pulldown .= '<option value="' . $code . '"' . $selected . '>' . $country . '</option>';
    }
